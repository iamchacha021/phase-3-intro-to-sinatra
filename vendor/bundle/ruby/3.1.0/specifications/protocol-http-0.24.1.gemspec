# -*- encoding: utf-8 -*-
# stub: protocol-http 0.24.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.authors = ["Samuel Williams".freeze, "Herrick Fang".freeze, "Bruno Sutic".freeze, "Bryan Powell".freeze, "Dan Olson".freeze, "Olle Jonsson".freeze, "Yuta Iwama".freeze]
